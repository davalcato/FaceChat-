...
class PhotoListController: UIViewController {
    ...
    lazy var dataSource: PhotoDataSource = {
        return PhotoDataSource(fetchRequest: Photo.allPhotosRequest as! NSFetchRequest<NSManagedObject>, collectionView: self.collectionView)
    }()
...
extension PhotoListController {
    ...
    @objc private func presentSortController() {
        let tagDataSource = SortableDataSource<Tag>(fetchRequest: Tag.allTagsRequest as! NSFetchRequest<NSManagedObject>, managedObjectContext: CoreDataController.sharedInstance.managedObjectContext)
